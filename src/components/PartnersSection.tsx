        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            <svg 
              ...
              fill="none"
            >
              <circle cx="50" cy="50" r="45" stroke="currentColor" strokeWidth="6" className="text-foreground/20"/>
              <circle cx="50" cy="50" r="20" fill="currentColor" className="text-foreground"/>
            </svg>
            <span className="text-2xl font-bold text-foreground">ElevenLabs</span>
          </div>
