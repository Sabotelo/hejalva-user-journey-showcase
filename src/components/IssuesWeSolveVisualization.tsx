...
const issues = [
  {
    ...
    descriptionEn: "Customers call after hours – and go to your competitors when no one answers.",
    descriptionSv: "Kunder ringer efter stängning – och går till konkurrenterna när ingen svarar.",
    icon: Clock,
  },
  {
    id: 2,
    ...
    descriptionEn: "Long hold times mean lost customers. They hang up and won't call back.",
    descriptionSv: "Långa väntetider betyder förlorade kunder. De lägger på och ringer inte tillbaka.",
    icon: PhoneMissed,
  },
  {
    id: 3,
