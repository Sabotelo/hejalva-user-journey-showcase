...
const issues = [
  {
    ...
    descriptionEn: "51% of customers expect 24/7 availability. After-hours calls go to your competitors.",
    descriptionSv: "51% av kunderna förväntar sig tillgänglighet dygnet runt. Samtal efter stängning går till konkurrenterna.",
    icon: Clock,
  },
  {
    id: 2,
    titleEn: "The Missed Call Problem",
    titleSv: "Problemet Med Missade Samtal",
    descriptionEn: "Businesses answer only 37.8% of inbound calls. Every missed call is lost revenue.",
    descriptionSv: "Företag svarar bara på 37,8% av inkommande samtal. Varje missat samtal är förlorad intäkt.",
    icon: PhoneMissed,
  },
  {
    id: 3,
