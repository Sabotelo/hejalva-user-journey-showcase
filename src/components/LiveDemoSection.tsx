...
const TRANSCRIPT_SFX: Record<string, Record<number, string>> = {
  ...
  workshop: {
    0: "/audio/Workshop/Workshop_1.mp3",
    1: "/audio/Workshop/Workshop_2.mp3",
    2: "/audio/Workshop/Workshop_3.mp3",
    3: "/audio/Workshop/Workshop_4.mp3",
  },

  afterhours: {
    0: "/audio/Afterhours/afterhours_1.mp3",
    1: "/audio/Afterhours/afterhours_2.mp3",
    2: "/audio/Afterhours/afterhours_3.mp3",
    3: "/audio/Afterhours/afterhours_4.mp3",
  },
};
...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    transcript: [
      ...
      { speaker: "caller", text: "Ja snälla.", timestamp: 13 },
      {
        speaker: "alva",
    ...
    actions: [
      ...
      { label: "Action", value: "Provisional Booking 07:30", status: "processing", timestamp: 13 },
